...
cutoff.date <- c("2020-10-31")     ##cutoff for GTA 26
...
transparent.policy.instruments <- c("Anti-circumvention", "Anti-dumping", "Anti-subsidy", "Import monitoring", "Safeguard", "Special safeguard",
                                    "Import tariff", "Import quota","Import tariff quota", "Export quota", "Export tariff quota", "Export tax", "Import ban", "Export ban")
