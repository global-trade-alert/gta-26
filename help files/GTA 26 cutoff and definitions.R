...
transparent.policy.instruments <- c("Anti-circumvention", "Anti-dumping", "Anti-subsidy", "Import monitoring", "Safeguard", "Special safeguard",
                                    "Import tariff", "Import quota","Import tariff quota", "Import licensing requirement", "Export quota", "Export tax", "Export licensing requirement", "Import ban", "Export ban")
