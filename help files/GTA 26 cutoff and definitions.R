...
cutoff.date <- c("2020-10-30")     ##cutoff for GTA 26
...
transparent.policy.instruments <- c("Anti-circumvention", "Anti-dumping", "Anti-subsidy", "Import monitoring", "Safeguard", "Special safeguard",
                                    "Import tariff", "Import quota","Import tariff quota", "Import licensing requirement", "Export quota", "Export tariff quota", "Export tax", "Export licensing requirement", "Import ban", "Export ban")
...
# se.country.groups <- data.frame("group" = c("Least Developed Countries", "Sub-Saharan Africa", "African Union", "Latin American and Caribbean nations", "EBRD countries of operation", "ASEAN", "East Asia and Pacific", "Eurasian Economic Union"),
#                                 "member" = c(paste(country.names$name[country.names$is.ldc], collapse = ", "),
#                                              paste(c("Angola", "Burundi", "DR Congo", "Cameroon", "Central African Republic", "Chad", "Congo", "Equatorial Guinea", "Gabon", "Kenya", "Nigeria", "Rwanda", "Sao Tome & Principe", "Tanzania", "Uganda", "Republic of the Sudan", "South Sudan", "Djibouti", "Eritrea", "Ethiopia", "Somalia", "Botswana", "Comoros", "Lesotho", "Madagascar", "Malawi", "Mauritius", "Mozambique", "Namibia", "Seychelles", "South Africa", "Swaziland", "Zambia", "Zimbabwe", "Benin", "Mali", "Burkina Faso", "Cape Verde", "Ivory Coast", "Gambia", "Ghana", "Guinea", "Guinea-Bissau", "Liberia", "Mauritania", "Niger", "Senegal", "Sierra Leone", "Togo"), collapse = ", "),
#                                              paste(c("Algeria", "Angola", "Botswana", "Burundi", "Cameroon", "Cape Verde", "Central African Republic", "Chad", "Comoros", "Congo", "DR Congo", "Benin", "Equatorial Guinea", "Ethiopia", "Eritrea", "Djibouti", "Gabon", "Gambia", "Ghana", "Guinea", "Ivory Coast", "Kenya", "Lesotho", "Liberia", "Libya", "Madagascar", "Malawi", "Mali", "Mauritania", "Mauritius", "Morocco", "Mozambique", "Namibia", "Niger", "Nigeria", "Guinea-Bissau", "Rwanda", "Sao Tome & Principe", "Senegal", "Seychelles", "Sierra Leone", "Somalia", "South Africa", "Zimbabwe", "South Sudan", "Republic of the Sudan", "Western Sahara", "Swaziland", "Togo", "Tunisia", "Uganda", "Egypt", "Tanzania", "Burkina Faso", "Zambia"), collapse = ", "),
#                                              paste(c("Antigua & Barbuda", "Argentina", "Barbados", "Belize", "Bolivia", "Brazil", "Chile", "Colombia", "Costa Rica", "Cuba", "Dominica", "Dominican Republic", "Ecuador", "El Salvador", "Grenada", "Guatemala", "Guyana", "Haiti", "Honduras", "Jamaica", "Mexico", "Nicaragua", "Panama", "Paraguay", "Peru", "Puerto Rico", "Saint Kitts & Nevis", "Saint Lucia", "Saint Vincent & the Grenadines", "Suriname", "Bahamas", "Trinidad & Tobago", "Uruguay", "Venezuela"), collapse = ", "),
#                                              paste(country.names$name[country.names$is.ebrd], collapse = ", "),
#                                              paste(country.names$name[country.names$is.asean], collapse = ", "),
#                                              paste(c("American Samoa", "Australia", "Brunei Darussalam", "Cambodia", "China", "Fiji", "French Polynesia", "Guam", "Hong Kong", "Indonesia", "Japan", "Kiribati", "DPR Korea", "Republic of Korea", "Lao", "Macao", "Malaysia", "Marshall Islands", "Micronesia", "Mongolia", "Myanmar", "Nauru", "New Caledonia", "New Zealand", "Northern Mariana Islands", "Palau", "Papua New Guinea", "Philippines", "Samoa", "Singapore", "Solomon Islands", "Thailand", "Timor-Leste", "Tonga"), collapse = ", "),
#                                              paste(c("Armenia", "Belarus", "Kazakhstan", "Kyrgyzstan", "Russia"), collapse = ", ")))
# se.country.groups <- cSplit(se.country.groups, splitCols = "member", direction = "long")

se.country.groups <- list("Least Developed Countries" = country.names$name[country.names$is.ldc],
                          "Sub-Saharan Africa" = c("Angola", "Burundi", "DR Congo", "Cameroon", "Central African Republic", "Chad", "Congo", "Equatorial Guinea", "Gabon", "Kenya", "Nigeria", "Rwanda", "Sao Tome & Principe", "Tanzania", "Uganda", "Republic of the Sudan", "South Sudan", "Djibouti", "Eritrea", "Ethiopia", "Somalia", "Botswana", "Comoros", "Lesotho", "Madagascar", "Malawi", "Mauritius", "Mozambique", "Namibia", "Seychelles", "South Africa", "Swaziland", "Zambia", "Zimbabwe", "Benin", "Mali", "Burkina Faso", "Cape Verde", "Ivory Coast", "Gambia", "Ghana", "Guinea", "Guinea-Bissau", "Liberia", "Mauritania", "Niger", "Senegal", "Sierra Leone", "Togo"),
                          "African Union" = c("Algeria", "Angola", "Botswana", "Burundi", "Cameroon", "Cape Verde", "Central African Republic", "Chad", "Comoros", "Congo", "DR Congo", "Benin", "Equatorial Guinea", "Ethiopia", "Eritrea", "Djibouti", "Gabon", "Gambia", "Ghana", "Guinea", "Ivory Coast", "Kenya", "Lesotho", "Liberia", "Libya", "Madagascar", "Malawi", "Mali", "Mauritania", "Mauritius", "Morocco", "Mozambique", "Namibia", "Niger", "Nigeria", "Guinea-Bissau", "Rwanda", "Sao Tome & Principe", "Senegal", "Seychelles", "Sierra Leone", "Somalia", "South Africa", "Zimbabwe", "South Sudan", "Republic of the Sudan", "Western Sahara", "Swaziland", "Togo", "Tunisia", "Uganda", "Egypt", "Tanzania", "Burkina Faso", "Zambia"),
                          "Latin American and Caribbean nations" = c("Antigua & Barbuda", "Argentina", "Barbados", "Belize", "Bolivia", "Brazil", "Chile", "Colombia", "Costa Rica", "Cuba", "Dominica", "Dominican Republic", "Ecuador", "El Salvador", "Grenada", "Guatemala", "Guyana", "Haiti", "Honduras", "Jamaica", "Mexico", "Nicaragua", "Panama", "Paraguay", "Peru", "Puerto Rico", "Saint Kitts & Nevis", "Saint Lucia", "Saint Vincent & the Grenadines", "Suriname", "Bahamas", "Trinidad & Tobago", "Uruguay", "Venezuela"),
                          "EBRD countries of operation" = country.names$name[country.names$is.ebrd],
                          "ASEAN" = country.names$name[country.names$is.asean],
                          "East Asia and Pacific" = c("American Samoa", "Australia", "Brunei Darussalam", "Cambodia", "China", "Fiji", "French Polynesia", "Guam", "Hong Kong", "Indonesia", "Japan", "Kiribati", "DPR Korea", "Republic of Korea", "Lao", "Macao", "Malaysia", "Marshall Islands", "Micronesia", "Mongolia", "Myanmar", "Nauru", "New Caledonia", "New Zealand", "Northern Mariana Islands", "Palau", "Papua New Guinea", "Philippines", "Samoa", "Singapore", "Solomon Islands", "Thailand", "Timor-Leste", "Tonga"),
